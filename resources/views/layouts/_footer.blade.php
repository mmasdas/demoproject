                                ...
                                <div class="relative">
                                    <div class="absolute left-0 top-3 origin-left transition-opacity h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10"
                                        ...
                                        style="transform:var(--avatar-image-transform)" href="/"><img alt=""
                                            ...
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar.51a13c67.jpg&amp;w=3840&amp;q=75" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="relative flex gap-4">
                                    ...
                                    <div class="flex flex-1 justify-end md:justify-center">
                                        <div class="pointer-events-auto md:hidden" data-headlessui-state=""><button
                                                ...
                                                type="button" aria-expanded="false" data-headlessui-state="">Menu<svg
                                    ...
                                    <div class="flex justify-end md:flex-1">
                                        <div class="pointer-events-auto"><button type="button" aria-label="Toggle theme"
                                        ...
                                        <ol class="mt-6 space-y-4">
                                            <li class="flex gap-4">
                                                ...
                                                <dl class="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2019 until Present"><time
                                            ...
                                            <li class="flex gap-4">
                                                ...
                                                <dl class="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dt class="sr-only">Date</dt>
                                                    <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2014 until 2019"><time dateTime="2014">2014</time>
                                            ...
                                            <li class="flex gap-4">
                                                ...
                                                <dl class="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dt class="sr-only">Date</dt>
                                                    <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2011 until 2014"><time dateTime="2011">2011</time>
                                                        <span aria-hidden="true">—</span> <time
                                            ...
                                            <li class="flex gap-4">
                                                ...
                                                <dl class="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dt class="sr-only">Date</dt>
                                                    <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2008 until 2011"><time dateTime="2008">2008</time>
                                                        <span aria-hidden="true">—</span> <time
